...
export class InspectorView extends Disposable {
        ...
        constructor(parent: HTMLElement) {
                ...
                this._register(sceneBridge.onEntitySelected(id => {
                        console.log('[Inspector] Entity selected:', id);
                        this.selectedId = id;
                        this.render();
                }));
        }
        ...
        private render(): void {
                ...
                console.log('[Inspector] render() called, selectedId:', this.selectedId);
                ...
                console.log('[Inspector] Total entities:', entities.length);
                
                const ent = sceneBridge.findEntity(entities, this.selectedId);
                console.log('[Inspector] Found entity:', ent?.name, 'components:', ent?.components.length);
                ...
                for (const c of ent.components) {
                        console.log('[Inspector] Rendering component:', c.type);
                        this.section(c);
                }
        }
