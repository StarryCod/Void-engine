...
export class WindowsMainService extends Disposable implements IWindowsMainService {
	...
	private getRestoreWindowsSetting(): RestoreWindowsSetting {
		// VOID ENGINE: ВСЕГДА возвращаем 'none' чтобы не восстанавливать окна
		// Welcome Screen должен показываться при каждом запуске
		return 'none';
		
		/* Original logic - disabled for Void Engine
